# petimg + AWS S3 with Node.JS

A simple and fully working example of petimg and AWS S3 storage with Node.js (and
...
```sh
corepack yarn workspace @petimg-example/aws-nodejs start
```
